...
python -m wafer_defect_detection.train \
    --mode train \
    --dataset wafer \
    --data_dir ./data \
    --epochs 200 \
...
python train_simsiam.py \
    ...
    --data_dir ./data \
    --val_ratio 0.2 \
    --checkpoint ./checkpoints_simsiam/best_model_wafer.pth \
    --score_mode combined
...
python run_ablation.py \
    --data_dir ./data \
    --save_dir ./ablation_results_large \
    --img_size 384 \
    --embed_dim 512 \
    --epochs 200 \
    --batch_size 16 \
