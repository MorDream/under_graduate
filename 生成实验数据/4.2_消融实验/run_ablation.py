...
def parse_auroc_f1(output: str):
    """从 recontrast_vit_wafer.py 输出中解析 AUROC 和 F1"""
    # 匹配 "AUROC:0.9234" 或 "AUROC: 0.9234"
...
def main():
    ...
    if args.all:
        ...
        experiments = EXPERIMENTS[:1]  # 只跑 Baseline
